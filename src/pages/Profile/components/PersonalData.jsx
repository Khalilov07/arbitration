...
const PersonalData = () => {
    return (
        <div>
            ...
            <div className='flex-col sm:flex gap-10 items-center '>
                <img src="./images/Profile/beg.png" className='w-[50%] sm:w-[12%]' alt="" />
            ...
            <div className='w-full flex-col sm:flex gap-5 pt-5'>
