...
const Four = () => {
    const styles = {
        section: {
            minHeight: "80vh",
            background: "rgb(174, 145, 116)",
            backgroundSize: "cover",
            backgroundPosition: "center",
            backgroundBlendMode: "overlay",
            backgroundImage: 'linear-gradient(rgba(174, 145, 116, 0.2), rgba(174, 145, 116, 0.2)), url("./images/Main/FourBackground.png")'
        },
        imageContainer: {
            flex: "1 1 45%",
            maxWidth: "45%",
    ...
    return (
        <section style={styles.section} className="text-black flex flex-wrap py-14 px-5" >
